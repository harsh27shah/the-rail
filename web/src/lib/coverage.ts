 ...
 * per the owner) so its floor is lower and softer. The remaining categories (Knitwear,
 * Suiting, Footwear, Activewear, Accessories) don't have an agreed minimum yet — leave them
 * unbadged rather than guess at a number. Revisit once there's a clearer read on what "enough
 * footwear" or "enough accessories" means.
 */
